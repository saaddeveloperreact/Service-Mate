              ...
              <Card className="border-0 shadow-xl">
                <CardContent className="p-8">
                  ...
                  <div className="mt-6 pt-5 border-t border-gray-100 dark:border-gray-700 text-center space-y-2">
                    <Link to="/forgot-password" className="text-sm text-gray-500 dark:text-gray-400 hover:text-primary-600 block">Forgot your password?</Link>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Don't have an account?{' '}<Link to="/user/register" className="text-primary-600 dark:text-primary-400 font-semibold hover:underline">Register here</Link></p>
                    <p className="text-xs text-gray-400 dark:text-gray-500">Are you a provider?{' '}<Link to="/provider/login" className="text-accent-500 font-semibold hover:underline">Login here</Link></p>
                  </div>
                </CardContent>
              </Card>
            </motion.div>
